  ...
  return (
    <>
      ...
      <section id="stores">
        ...
        <p className="note" style={{ marginTop: 12 }}>※ ★は採用の優先度です（★が多いほど強化中）。<br />※ 絞り込みボタンは<b>複数選択できます</b>（もう一度押すと解除・「すべて」でリセット）。エリア担当が複数の方は担当エリアをまとめて選択してください。<br />※ 列の見出しをクリックすると並び替えできます（もう一度クリックで昇順⇄降順）。<br />※ 上記以外のセレスト各店も、指名のお客様を50名以上お連れいただける方は全店舗でご紹介可能です（前店と同じ価格でのメニュー導入可・指名のお客様優先の施術可）。<br />※ カラー専門店は、土日祝・遅番に出勤できる方なら週1〜2日でも歓迎です（早番はブランクのない方であれば週1〜2日でも可）。</p>
      </section>
