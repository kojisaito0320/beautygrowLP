...
export const miraizm: PartnerConfig = {
  ...
  summary: {
    dealChanges: [
      { badge: "NEW", text: "小原様の記録を追加（2025年1月入社→6月退職）。金子様は記録整理のため除外（成約9名に）" },
      { text: "在籍中: 江黒様・桑江様・川口様・谷崎様（詳細は下表の「その後」参照）" },
      { text: "富永様 2026年9月入社予定（内定）／鈴木様・眞木様・上地様は退職" },
  ...
  referralSummary: {
    ...
    rows: [
      ...
      { name: "富永様", agent: "井上様", brand: "matsuge", brandLabel: "まつげ", shop: "栄", joined: "2026年9月 予定", outcome: "内定（正社員・9月より東京研修）" },
    ],
    privacyNote:
  ...
  referrals: {
    ...
    tableNoteLines: [
      "※ 2026/8/17時点・共有スプレッドシート「ご紹介者様」タブより転記（年の記載がない日付は前後の記録から補完しています）。ステータスの原文・補足は同タブをご確認ください。",
      "※ 列の見出しをクリックすると並び替えできます（もう一度クリックで昇順⇄降順）。絞り込みボタンは複数選択できます。",
    ],
    footerNote:
      "本ページは株式会社Beauty Growとミライズム様の人材紹介取引に関する機密資料です。候補者様の個人情報を含むため、取り扱いにご注意ください。｜最終更新 2026年8月17日",
  },
};
